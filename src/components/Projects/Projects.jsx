                ...
                <CardBody>
                  ...
                  <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
                    ...
                    <Tooltip content={project.github}>
                      <span onClick={() => project.githublink && handleClick(project.githublink)}  target="_blank" className="cursor-pointer rounded-full border border-pink-900/5 bg-pink-900/50 p-3 text-pink-400 transition-colors hover:border-pink-900/10 hover:bg-pink-900/10 hover:!opacity-100 group-hover:opacity-70">
