        ...
        <div  key={project.id} className="project-cards">
          ...
          >
            <CardHeader
              floated={false}
              color="transparent"
              className="flex justify-center w-full mt-0 mx-0"
            >
              <img
                className="h-full"
            ...
            <CardBody>
              <div className="flex flex-col gap-2 h-[140px] md:h-[140px]">
                <Typography
                  variant="h4"
                  color="white"
              ...
              <CardFooter className="text-center mt-7">
                <Button
                  onClick={() => handleClick(project.link)}
                  target="_blank"
                  className="font-audiowide text-[#fffc00] text-[0.7em] sm:text-[1em] px-9 sm:px-20 relative overflow-hidden bg-gradient-to-l from-purple-600 to-pink-600 mt-7 text-center"
                >
